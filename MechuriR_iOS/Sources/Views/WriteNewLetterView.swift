...
struct WriteNewLetterView: View {
    ...
    var body: some View {
        ZStack {
            VStack {
                WriteNewLetterTopCell(isPresentPopup: $isPresentPopup)
            ...
            if(isPresentPopup){
                LetterAlertCell(isPresentPopup: $isPresentPopup)
                    .padding(.horizontal)
